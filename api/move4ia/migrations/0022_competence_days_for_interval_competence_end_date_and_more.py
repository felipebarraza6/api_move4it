...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('move4ia', '0021_rename_image_typemedition_image_off_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activities', models.ManyToManyField(to='move4ia.activity', verbose_name='actividades')),
                ('competence', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='move4ia.competence', verbose_name='competencia')),
            ],
            options={
