...
# Models
from api.move4ia.models import Competence, Enterprise, Group
from api.move4ia.serializers import CompetenceRankingSerializer,CompetenceSerializer, EnterpriseSerializer, GroupSerializerList, GroupSerializer, CompetenceRetrieveSerializer
