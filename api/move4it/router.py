...
from api.move4it.views import blogs as views_blogs, enterprises as views_enterprises, activities as views_activities, registers_activity as views_registers_activity
